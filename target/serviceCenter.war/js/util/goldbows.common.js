/**
 * Created by GoldBows on 5/13/2015.
 */

var GOLDBOWS = GOLDBOWS || {};
GOLDBOWS.module = GOLDBOWS.module || {};

GOLDBOWS.namespace = function() {
        ...
        ajaxCall : function(customOptions, doneFn, failFn) {
            ...
            if (failFn) {
                ...
                request.fail(function(jqXHR, textStatus, errorThrown) {
                    GOLDBOWS.message(GOLDBOWS.messageType.ERROR, "Your Session is expired. Please re-login to the system");
                });
            }
            if (doneFn) {
                request.done(doneFn);
